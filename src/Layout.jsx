...
export default function Layout() {
  return (
    <div style={{ backgroundColor: 'var(--color-bg)', color: 'var(--color-text)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      {/* Header */}
      <header style={{ padding: '20px', borderBottom: '1px solid #333', display: 'flex', justifyContent: 'center', gap: '32px' }}>
        <Link to="/" style={{ color: 'var(--color-text)', textDecoration: 'none' }}>Home</Link>
        <Link to="/blog" style={{ color: 'var(--color-text)', textDecoration: 'none' }}>Blog</Link>
        <a href="https://app.ravgrowth.com" style={{ color: 'var(--color-text)', textDecoration: 'none' }} target="_blank" rel="noopener noreferrer">
        RavBot
        </a>
      ...
      {/* Footer */}
      <footer style={{ padding: '20px', borderTop: '1px solid #333', textAlign: 'center', fontSize: '0.9rem', color: '#aaa' }}>
